defmodule T3CloneElixirWeb.ModelLiveTest do
  use T3CloneElixirWeb.ConnCase

  import Phoenix.LiveViewTest
  import T3CloneElixir.ModelsFixtures

  @create_attrs %{name: "some name", openrouter_name: "some openrouter_name", allow_images: true, allow_files: true}
  @update_attrs %{name: "some updated name", openrouter_name: "some updated openrouter_name", allow_images: false, allow_files: false}
  @invalid_attrs %{name: nil, openrouter_name: nil, allow_images: false, allow_files: false}
